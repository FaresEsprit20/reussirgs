...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('eo719evhcE', 0, ($this->targetDirs[0].'/pools'));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('std1X7aNcP', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('gdBj5guHFp', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('SttwWgM-GH', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\vendor\\doctrine\\doctrine-bundle/Resources/views'), '!Doctrine');
        $instance->addPath(($this->targetDirs[3].'\\src\\GsBundle/Resources/views'), 'Gs');
        $instance->addPath(($this->targetDirs[3].'\\src\\GsBundle/Resources/views'), '!Gs');
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = [
                ...
                'GsBundle' => [
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\GsBundle'),
                    'namespace' => 'GsBundle',
                ],
                'DebugBundle' => [
                    'parent' => NULL,
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'database_port' => NULL,
            'database_name' => 'reussirgs',
            'database_user' => 'root',
            'database_password' => NULL,
            'mailer_transport' => 'gmail',
            'mailer_host' => 'smtp.gmail.com',
            'mailer_user' => 'faresbenslama95@gmail.com',
            'mailer_password' => 'Zakataka2020',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'faresbenslama95@gmail.com',
            'swiftmailer.mailer.default.transport.smtp.password' => 'Zakataka2020',
            ...
            'fos_user.model.user.class' => 'GsBundle\\Entity\\User',
            ...
            'fos_user.registration.confirmation.from_email' => [
                'faresbenslama95@gmail.com' => 'faresbenslama95@gmail.com',
            ],
            'fos_user.registration.confirmation.enabled' => false,
            'fos_user.registration.form.type' => 'GsBundle\\Form\\UserType',
